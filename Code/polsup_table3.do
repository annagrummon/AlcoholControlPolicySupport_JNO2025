*Estimate results for Table 3 - Associations of behavioral and demographic characteristics with support for specific alcohol control policies 
...
* Create new age variable (regrouping)
gen agecat_model = .
...
*Set the list of right-hand-side variables 
...
* Run each regression 
foreach policy in polsup_calories polsup_ads polsup_standard polsup_cancer polsup_bac  polsup_night polsup_taxes polsup_licenses  {
	svy: regress `policy'  $correlates
}
