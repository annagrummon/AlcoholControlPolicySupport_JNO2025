*Estimate results for Table 2 - Associations between demographic and behavioral characteristics and overall support for alcohol control policies
...
* First, set list of predictor variables 
global correlates i.alcdaysdrankcat i.alctimesbingecat i.yesnoticed i.yesused i.religpractice_model i.agecat_model ib2.gendercat_model i.sexualorientcat i.racecat_model i.educcat_model i.fplcat  ib2.partyidcat  i.REGION4_norc 

* Check variance inflation factors to ensure no harmful multi-collinearity 
regress overall_polsup  $correlates
	*Estimate VIFs 
	estat vif

* Check for heteroscadisticity 
regress overall_polsup  $correlates
	*Run the Bresuch-Pagan test
	estat hettest

* Check for ~normality of errors (visual inspection)
svy: regress overall_polsup  $correlates
	*Create Q-Q plot
